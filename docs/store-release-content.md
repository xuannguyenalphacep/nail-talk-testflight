...
Username: appreview2026
Password: enter the reviewer password directly in App Store Connect; do not commit it here.
...
iPhone 6.7-inch screenshots are ready at:

```text
docs/store-screenshots/iphone67/app-store/
```
...
```text
docs/store-screenshots/iphone67/raw/
```
