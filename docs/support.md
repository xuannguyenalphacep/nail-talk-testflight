...
If you need help with the app, include:
...
Yes. Open the Register tab, choose a username and password, and complete the form. Email and phone fields may be added or updated later in your profile.
...
Add the public support email or contact form URL here before submitting the app to the store.
